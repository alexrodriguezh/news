        ...
        <>
            ...
            <main className="flex w-2/3 m-auto">
                <div className="bg-white w-9/12 mb-8">
                    ...
                    <div className="font-serif lg:text-4xl md:text-2xl sm:text-sm font-bold leading-none">{data.noticia.titulo}</div>
                    ...
                    <div className="font-display text-lg font-medium text-gray-700 leading-loose">{ReactHtmlParser(data.noticia.contenido)}</div>
                </div>
