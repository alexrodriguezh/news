        ...
        <>
            ...
            <main className="flex flex-wrap container m-auto">
                <div className="bg-white flex flex-wrap w-full xl:w-9/12 lg:w-9/12 md:w-2/3 sm:w-full m-auto md:pr-3">
                    ...
                    <div className="font-serif lg:text-4xl md:text-2xl sm:text-2xl text-lg font-bold leading-none px-2">{data.noticia.titulo}</div>
                    ...
                    <div className="font-display lg:text-lg md:text-lg sm:text-md text-sm font-medium text-gray-700 leading-relaxed px-2">{ReactHtmlParser(data.noticia.contenido)}</div>
                </div>
